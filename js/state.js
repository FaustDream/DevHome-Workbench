...
(function (ns) {
    ...
    ns.dom = {
        ...
        modalOverlay: ns.$('#modalOverlay'),
        tileModal: ns.$('#tileModal'),
        modalTitle: ns.$('#modalTitle'),
        modalClose: ns.$('#modalClose'),
        modalCancel: ns.$('#modalCancel'),
        modalSave: ns.$('#modalSave'),
        faGroup: ns.$('#faGroup'),
        imageGroup: ns.$('#imageGroup'),
        emojiGroup: ns.$('#emojiGroup'),
        faInput: ns.$('#faInput'),
        imageInput: ns.$('#imageInput'),
        imageUploadArea: ns.$('#imageUploadArea'),
        imagePreview: ns.$('#imagePreview'),
        emojiInput: ns.$('#emojiInput'),
        labelInput: ns.$('#labelInput'),
        urlInput: ns.$('#urlInput'),
        colorInput: ns.$('#colorInput'),
        faPreview: ns.$('#faPreview'),
        bgContainer: ns.$('#bgContainer'),
        bgImage: ns.$('#bgImage'),
        bgVideo: ns.$('#bgVideo'),
        bgOverlay: ns.$('#bgOverlay'),
        bgInput: ns.$('#bgInput'),
        pageIndicator: ns.$('#pageIndicator'),
        pageName: ns.$('#pageName'),
        pageInfo: ns.$('#pageInfo'),
        prevPage: ns.$('#prevPage'),
        nextPage: ns.$('#nextPage'),
        categoryPopover: ns.$('#categoryPopover'),
        ...
        changelogOverlay: ns.$('#changelogOverlay'),
        changelogCloseBtn: ns.$('#changelogCloseBtn'),
        // 文件配置 UI
